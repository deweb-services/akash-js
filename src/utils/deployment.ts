...
import { GroupSpec } from "../codec/akash/deployment/v1beta2/group";
...
import { Storage } from "../codec/akash/base/v1beta2/storage";
            ...
            if (expose.to) {
              expose.to.forEach((to) => {
                if (to.global) {
                  ...
                  endpoints.push({ kind: kind, sequence_number: kind });
                }
              });
            }
          });
